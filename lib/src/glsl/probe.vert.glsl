// Probe pass entry point: the render stage with every transform set to identity,
// writing each particle's corner into a readback canvas instead of the screen.
// See grain_probe_system.
